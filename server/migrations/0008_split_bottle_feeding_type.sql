-- Split the generic "bottle" feeding type into "bottle_breast_milk" and "bottle_formula"
...
SELECT id, child_id,
  CASE WHEN type = 'bottle' THEN 'bottle_formula' ELSE type END,
  start_time, end_time, amount, amount_unit, notes, created_at, updated_at, created_by_user_id
FROM feedings;
